...
export default function ContactSection({ translate }: ContactSectionProps) {
  return (
    <section id="contact" className="py-24 relative bg-cosmic-void overflow-hidden">
      {/* Background patterns */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 premium-card p-4 rounded-xl border-l-2 border-posta-orange">
              ...
              <div className="flex items-center gap-4 premium-card p-4 rounded-xl border-l-2 border-surge-teal">
              ...
              <div className="flex items-center gap-4 premium-card p-4 rounded-xl border-l-2 border-sa-gold">
          ...
          <div className="lg:col-span-3">
            <div className="glass-card p-8 md:p-10 rounded-3xl relative overflow-hidden">
              ...
              <div className="flag-accent mb-8"></div>
