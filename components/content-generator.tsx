                ...
                <div>
                    ...
                    <div className="relative">
                        <select 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white appearance-none focus:border-joburg-teal focus:outline-none font-body cursor-pointer"
                        >
                            <option value="Mzansi Cool (Local Slang)">Mzansi Cool 🇿🇦</option>
                            <option value="Professional Corporate">Corporate Pro</option>
                            <option value="High Energy Cyberpunk">Cyberpunk Energy</option>
                            <option value="Warm & Community">Warm Community</option>
                        </select>
                        <i className="fa-solid fa-chevron-down absolute right-4 top-4 text-gray-500 pointer-events-none text-xs"></i>
                    </div>
                </div>
                <div>
